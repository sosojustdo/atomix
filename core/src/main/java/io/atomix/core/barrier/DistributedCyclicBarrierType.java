 ...
 */
public class DistributedCyclicBarrierType implements DistributedPrimitive.Type<DistributedCyclicBarrier.Builder, DistributedCyclicBarrier.Config, DistributedCyclicBarrier> {
