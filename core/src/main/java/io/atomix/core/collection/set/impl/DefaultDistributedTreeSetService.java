...
public class DefaultDistributedTreeSetService<E extends Comparable<E>> extends AbstractDistributedSetService<NavigableSet<E>, E> implements DistributedTreeSetService<E> {
  ...
  protected class DescendingIteratorContext extends DefaultDistributedCollectionService.AbstractIteratorContext {
  ...
  protected class SubMapIteratorContext extends DefaultDistributedCollectionService.AbstractIteratorContext {
  ...
  protected class DescendingSubMapIteratorContext extends DefaultDistributedCollectionService.AbstractIteratorContext {
    private final E fromElement;
    private final boolean fromInclusive;
    private final E toElement;
    private final boolean toInclusive;
