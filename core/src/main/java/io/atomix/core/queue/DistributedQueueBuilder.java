 ...
 */
public abstract class DistributedQueueBuilder<E> extends DistributedPrimitive.Builder<DistributedQueueBuilder<E>, DistributedQueueConfig, DistributedQueue<E>> {
